...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sch="http://www.nrs.eskom.co.za/xmlvend/revenue/2.1/schema" xmlns:sch1="http://www.nrs.eskom.co.za/xmlvend/base/2.1/schema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
   ...
   <soapenv:Body>
      ...
      # => [{"units"=>{"value"=>"28.3", "siUnit"=>"KWh"}, "rate"=>{"value"=>"0.60", "symbol"=>"ANG"}},
      #     {"units"=>{"value"=>"8", "siUnit"=>"KWh"}, "rate"=>{"value"=>"0.64", "symbol"=>"ANG"}}]
    ...
    # STEP 1: credit-vend
    #   time_now = Time.now; request_id=rand(10**6); p = PagafasilImporters::PagatinuClient.new; rv1 = p.credit_vend_request amount: 10_00, currency: 'ANG', meter_no: '04257670465', created_at: time_now, request_id: request_id
    #
    # STEP 2: last-advice
