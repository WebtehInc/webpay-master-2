...
class Luhnacy
  @named = {
    ...
    # custom - we dont use these, creation is explicit by bin, this returns random bin prefix
    # :local => { :prefixes => WebPayAdmin.opts[:local_card_bins], :size => 16 }
    # :local => { :prefixes => ['440001', '440002'], :size => 16 }
  }
